...
namespace Team3FinalProject.Controllers
{
    public class CheckingAccountsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CheckingAccountID,AccountNumber,AccountBalance,AccountName")] CheckingAccount checkingAccount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CheckingAccountID,AccountNumber,AccountBalance,AccountName")] CheckingAccount checkingAccount)
        {
            if (ModelState.IsValid)
            {
